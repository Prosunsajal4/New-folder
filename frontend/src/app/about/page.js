...
const AboutUs = () => {
  const skills = {
    languages: ["JavaScript", "TypeScript", "Python", "Java", "C", "C++", "MATLAB"],
  ...
  const projects = [
    {
      ...
      description: "Developed an AI-based job matching system with personalized skill recommendations and real-time analytics dashboard, improving match accuracy and boosting user engagement by 30%.",
    ...
    },
    {
      ...
      description: "Developed a scalable online book selling platform with React and Node.js, implementing RBAC, secure authentication, protected routing, and responsive UI components to enhance user experience.",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <div className="mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-8">
              <a href="https://github.com" className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                <Github size={20} />
                <span>GitHub</span>
              </a>
              <a href="https://linkedin.com" className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                <Linkedin size={20} />
                <span>LinkedIn</span>
              </a>
              <a href="mailto:prosunsajal123@gmail.com" className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                <Mail size={20} />
                <span>prosunsajal123@gmail.com</span>
              </a>
              <a href="tel:+8801911572117" className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                <Phone size={20} />
        ...
        >
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            Passionate Frontend Developer with hands-on experience in React.js, Next.js, TypeScript, and Tailwind CSS, focused on building responsive and user-friendly web applications. Skilled in converting Figma designs into clean, pixel-perfect interfaces and integrating REST APIs using modern frontend practices. Seeking to join WhiteBox to contribute to high-quality frontend development, improve problem-solving skills, and grow in a collaborative learning environment.
          </p>
        </motion.div>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {project.highlights.map((highlight, highlightIndex) => (
                      <li key={highlightIndex} className="flex items-start gap-3 text-gray-700 dark:text-gray-300">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">Education & Certifications</h2>
          <div className="space-y-6">
            {education.map((edu, index) => (
              <div key={index} className="glass-card rounded-2xl p-6">
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg">
                    {edu.type === 'Certificate' ? <Award className="text-white" size={24} /> : <GraduationCap className="text-white" size={24} />}
                  </div>
                  <div className="flex-1">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">Languages</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {languages.map((lang, index) => (
              <div key={index} className="glass-card rounded-2xl p-6 text-center">
                <div className="text-2xl mb-2">
                  {lang.name === 'Bangla' ? '🇧🇩' : lang.name === 'English' ? '🇺🇸' : '🇮🇳'}
                </div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">
                  {lang.name}
                </h3>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-2xl font-bold gradient-text mb-4">StudentOS</h3>
              ...
              <div className="flex space-x-4">
                ...
                <a href="mailto:prosunsajal123@gmail.com" className="text-gray-400 hover:text-white transition-colors">
                  <Mail size={20} />
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="mailto:prosunsajal123@gmail.com" className="hover:text-white transition-colors">Contact</a></li>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2026 StudentOS. All rights reserved. Made with ❤️ by Prosun Mukherjee.</p>
          </div>
        </div>
      </footer>
    </div>
