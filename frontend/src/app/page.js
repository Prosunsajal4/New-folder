...
const LandingPage = () => {
  ...
  const features = [
    {
      ...
      description:
        "Track your exams with countdown timers and preparation checklists. Never miss a deadline again.",
    ...
    },
    {
      ...
      title: "Goal Setting",
      description:
        "Set and achieve your academic goals with progress tracking and milestone celebrations.",
    ...
    },
    {
      ...
      description:
        "Organize your assignments with due dates, priorities, and completion status.",
    ...
    },
    {
      ...
      description:
        "Visualize your academic progress with detailed charts and performance insights.",
    ...
    },
    {
      ...
      description:
        "Boost productivity with timed focus sessions and break reminders.",
    ...
    },
    {
      ...
      description:
        "Earn badges and rewards as you complete tasks and reach milestones.",
  ...
  const testimonials = [
    {
      ...
      content:
        "StudentOS transformed my academic life. The exam countdown and preparation checklists keep me organized and stress-free.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      content:
        "The goal tracking feature helped me improve my grades significantly. Highly recommend to all students!",
      rating: 5,
    },
    {
      name: "Emma Davis",
      ...
      content:
        "Managing assignments and study sessions has never been easier. The interface is intuitive and beautiful.",
      rating: 5,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-900 dark:to-gray-800">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Transform your academic experience with intelligent tools for exam
              preparation, assignment tracking, goal setting, and progress
              analytics. Join thousands of successful students worldwide.
            </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Real-time countdown with preparation checklists
                    </p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Visual insights into your performance
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Everything you need to excel in your studies, from exam
              preparation to progress tracking.
            </p>
          </motion.div>
      ...
      <section
        id="testimonials"
        className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-900/10 dark:to-indigo-900/10"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              See what students are saying about their academic transformation
              with StudentOS.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
              Join thousands of successful students who have improved their
              grades and reduced stress with StudentOS.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/register">
                <motion.button
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed max-w-md">
                ...
                management tools. Built with modern technologies to help you
              ...
              <div className="text-sm text-gray-400">
                <p className="mb-1">
                  <strong>Developed by:</strong> Prosun Mukherjee
                </p>
                <p className="mb-1">
                  <strong>Location:</strong> Khulna, Bangladesh
                </p>
                <p>
                  <strong>Contact:</strong> prosunsajal123@gmail.com |
                  +8801911572117
                </p>
              </div>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 mb-4 md:mb-0">
                &copy; 2026 StudentOS. All rights reserved. Made with ❤️ by
                Prosun Mukherjee.
              </p>
...
const HomeContent = () => {
  ...
  useEffect(() => {
    if (!loading && isAuthenticated && !showLanding) {
      router.push("/dashboard");
    }
  }, [isAuthenticated, loading, router, showLanding]);
